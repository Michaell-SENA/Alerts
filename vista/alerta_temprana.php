...
?>
	...
	<form action="../datos/registro_alerta.php" method="post" enctype="multipart/form-data">
		...
		<div class="row unid">
			<div class="col-md-6">Nombre: <input class="input-1" type="text" name="nombre"></div>
			<div class="col-md-6">Apellido: <input class="input-1" type="text" name="apellido"></div>
		</div>
		...
		<div class="row unid">
			...
			<div class="col-md-6">Numero de documento: <input class="input-1" type="number" name="num_doc"></div>

		</div>


		<div class="row unid">
			<div class="col-md-6">Teléfono: <input class="input-1" type="number" name="telefono"></div>
			<div class="col-md-6">Dirección de correspondencia: <input class="input-1" type="text" name="direccion"></div>
		</div>
		...
		<div class="row unid">
			...
			<div class="col-md-6">Programa de formación: <input class="input-1" type="text" name="programa"></div>
		...
		<div class="row unid">
			...
			<div class="col-md-6">Numero de ficha: <input class="input-1" type="number" name="ficha"></div>
		...
		<div class="row unid">
			...
			<div class="col-md-6">Acciones realizadas por parte del instructor: <input class="input-1" type="text" name="accion"></div>
		...
		<div class="row unid">
			<div class="col-md-6">Nombre: <input class="input-1" type="text" name="nombre_ins"></div>
			<div class="col-md-6">Apellido: <input class="input-1" type="text" name="apellido_ins"></div>
		</div>

		<div class="row unid">
			<div class="col-md-6">Número de telefono: <input class="input-1" type="number" name="telefono_ins"></div>
			<div class="col-md-6">Dirección de correo electrónico: <input class="input-1" type="text" name="correo_ins"></div>
		</div>
		<hr>
		<div class="col-md-12">
